...
<nav>
<ul class="nav justify-content-center navbar-light bg-light nav-pills font ">
  ...
  <div class="container text-center text-md-left mt-5" >
    ...
    <div class="row mt-3">
      ...
      <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
        ...
        <p>Food for Life works as a platform to coordinate between donor and humanitarian organization </p>
