            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select id="form_need" name="need" class="form-control" required="required" data-error="Please specify your need.">
                        <option value="">Want Food</option>
                        <option value="Request quotation">Need Food</option>
                        <option value="Request order status">Donate Food</option>
                        <option value="Request copy of an invoice">Register Problem</option>
                        <option value="Other">Login Problem</option>
                    </select>
                    <div class="help-block with-errors"></div>
                </div>
            </div>
